                ...
                <div className="navbar-end w-1/2 items-center">
                    {
                        user ? <div className="dropdown dropdown-end h-12">
                            ...
                            <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-4 shadow bg-white text-black rounded-box w-52 text-left">
                                ...
                                <Link onClick={logOut} className="pt-2 hover:text-primary" ><li>Logout</li></Link>
                            ...
                            <div className="flex gap-3">
                                <button className="text-md px-3 text-black font-space">Log In</button>
                                <button className="text-md bg-primary px-5 rounded-3xl text-white font-space">Register</button>
