        ...
        <div>
            <div className="my-10 max-w-6xl mx-auto md:my-20">
                <div className="gap-10 flex flex-col md:flex-row items-center justify-center">
                    <div className="card mx-auto flex-shrink-0 w-[95%] max-w-md border-[1px] border-primary rounded-xl bg-primary">
                        <div className="bg-primary rounded-xl pt-8 pb-5">
                            <h2 className="text-4xl text-white font-car bg-primary rounded-xl text-center pb-2 font-space font-bold">REGISTER</h2>
